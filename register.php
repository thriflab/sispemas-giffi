              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang</h1><h3 class="h4 text-gray-900 mb-4">Aplikasi Pengaduan Masyarakat</h3>
                  </div>
                  <form class="user" method="post" action="simpan_masyarakat.php">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <input type="text" name="telp" class="form-control form-control-user"  placeholder="Masukan Nomer Telepon">
                    </div>
                    <div class="form-group">
                    </div>
